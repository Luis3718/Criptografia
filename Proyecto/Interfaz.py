...
usuarios = [
    {'username': 'prof', 'password': '1234', 'role': 'profesor', 'name': 'Luis Manuel Alvarado Romero'},
    {'username': 'director', 'password': '1234', 'role': 'director', 'name': 'Pedro Miguel Ramirez Insunsa'},
    {'username': 'admin', 'password': '1234', 'role': 'administrador', 'name': 'Pedro Cruz Vazquez'},
]
...
def firmar_documento(user):
    ...
    guardar_firma(archivo_seleccionado, Ruta + user['role']+ "_Firma_doc.pdf", firma, '/firma_' + user['role'])
    print(f"Firma guardada en los metadatos del documento {user['role']}_Firma_doc.pdf")
...
def crear_ventana_login():
    ...
    img_path = Ruta+"imagenes/OIP.png"
